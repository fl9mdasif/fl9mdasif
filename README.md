...
<div style="margin-bottom: 30px;">
  <h2 align="left" style="border-bottom: 2px solid #000000; padding-bottom: 10px;">🚀 About Me</h2>

  I am **Md Asif Al Azad**, a **Tech Enthusiast** and **Jr. Full-Stack Developer** based in Dhaka, Bangladesh. I am dedicated to building scalable SaaS solutions and stay ahead of the curve through continuous learning.

  *   **Experience:** Over **2+ years of hands-on, real-world project experience** in crafting intuitive UIs and robust backend systems.
  *   **Entrepreneurial Mindset:** Currently driving impact by developing digital solutions for **Sultan Bazar**, focusing on organic and traditional food tech.
  *   **SaaS Specialist:** Architected and scaled AI-driven platforms like **VidMaxX** and **Resumind** using cutting-edge stacks.
  *   **Ownership:** Proven ability to develop, maintain, deploy and scale web applications using **React & Next.js**, **Node & Express.js**, and **HOSTINGER**.
  *   **Academic Excellence:** Completed **B.Sc. in Computer Science & Engineering** from **BUBT**.

  I take full **ownership** of the products I build, ensuring they are not just functional but also deliver a seamless user experience. **Let's connect and innovate together!**
</div>

<!-- Social Links -->
<div align="center" style="margin-bottom: 40px;">
  <a href="https://dev-mdasif-portolio.vercel.app" target="_blank">
...
<div style="margin-bottom: 40px;">
  ...
  <ul style="list-style-type: none; padding-left: 0;">
    ...
    <li style="margin: 15px 0;">
      🔎 <b><a href="https://ai-resume-analyzer-lense-8llxg.puter.site" style="text-decoration: none;">Resumind</a></b> — An AI assistant designed to help candidates navigate the modern hiring landscape.
    </li>
    <li style="margin: 15px 0;">
      📝 <b><a href="https://master.d3mia3lbsm9fsq.amplifyapp.com/login" style="text-decoration: none;">SmartBrief AI</a></b> — A React-based platform providing AI summarization with token management.
    </li>
    <li style="margin: 15px 0;">
      ⌨️ <b><a href="https://master.d26adgs03vcji6.amplifyapp.com/" style="text-decoration: none;">Typing Master</a></b> — A progressive touch-typing trainer built with React and TypeScript.
    </li>
    <li style="margin: 15px 0;">
      🩸 <b><a href="https://master.d18ycpe02we2yn.amplifyapp.com" style="text-decoration: none;">Blood Hub</a></b> — An online blood donation platform connecting donors and recipients.
    </li>
  </ul>
</div>
...
<!-- Technical Stack -->
<div style="margin-bottom: 40px;">
  <h2 style="border-bottom: 2px solid #000000; padding-bottom: 10px;">🛠️ Technical Stack</h2>
...
**Tools & DevOps:** ![AWS](https://img.shields.io/badge/AWS-232F3E?style=flat-square&logo=amazon-aws&logoColor=white) ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![Docker (Learning)](https://img.shields.io/badge/Docker_(Learning)-2496ED?style=flat-square&logo=docker&logoColor=white) ![n8n](https://img.shields.io/badge/n8n-FF6D5A?style=flat-square&logo=n8n&logoColor=white) ![Sentry](https://img.shields.io/badge/Sentry-362D59?style=flat-square&logo=sentry&logoColor=white) ![Postman](https://img.shields.io/badge/Postman-FF6C37?style=flat-square&logo=postman&logoColor=white) ![Jira](https://img.shields.io/badge/Jira-0052CC?style=flat-square&logo=jira&logoColor=white) ![LLM Integrations](https://img.shields.io/badge/LLM_Integrations-412991?style=flat-square&logo=openai&logoColor=white)

**Interpersonal Skills:**  
`Code Quality` • `Quick Learner` • `Leadership` • `Communication` • `Collaboration` • `Time Management` • `R&D`
</div>

<!-- Stats -->
<div style="margin-bottom: 20px;">
  <h2 align="left" style="border-bottom: 2px solid #000000; padding-bottom: 10px;">📈 Current Stats</h2>
